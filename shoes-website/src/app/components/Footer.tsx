...
return (
    <footer className='w-full h-1/4 flex flex-col justify-centeritems-center py-5 border-t-2'>
        <div id="foot-top" className='flex flex-col md:flex-row justify-around items-center'>
            <div id="foot-left">
                <h2 className='font-firlest text-3xl md:text-5xl font-bold'>Random Fashion</h2>
                <p className='text-lg'>Designed for Movement. Made for You.</p>
            </div>
            <div id="foot-right">
                <h3 className='text-lg font-bold my-[5%]'>Links</h3>
